...
# Display names for every NutritionFacts vitamin/mineral field, including the three
# (beta_carotene, boron, silicon) with no reference value - those still need a label
# for the raw-amount line in a meal reply, just never appear in %DV/coverage math.
